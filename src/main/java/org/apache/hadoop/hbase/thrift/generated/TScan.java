...
public class TScan implements org.apache.thrift.TBase<TScan, TScan._Fields>, java.io.Serializable, Cloneable, Comparable<TScan> {
  ...
  public java.nio.ByteBuffer startRow; // optional
  public java.nio.ByteBuffer stopRow; // optional
  public long timestamp; // optional
  public java.util.List<java.nio.ByteBuffer> columns; // optional
  public int caching; // optional
  public java.nio.ByteBuffer filterString; // optional
  ...
  private static final _Fields optionals[] = {_Fields.START_ROW,_Fields.STOP_ROW,_Fields.TIMESTAMP,_Fields.COLUMNS,_Fields.CACHING,_Fields.FILTER_STRING};
  ...
  public TScan setStartRow(java.nio.ByteBuffer startRow) {
  ...
  public TScan setStopRow(java.nio.ByteBuffer stopRow) {
  ...
  public TScan setColumns(java.util.List<java.nio.ByteBuffer> columns) {
  ...
  public TScan setFilterString(java.nio.ByteBuffer filterString) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<java.nio.ByteBuffer>(_list18.size);
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.nio.ByteBuffer _iter21 : struct.columns)
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.nio.ByteBuffer _iter22 : struct.columns)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.columns = new java.util.ArrayList<java.nio.ByteBuffer>(_list23.size);
          java.nio.ByteBuffer _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = iprot.readBinary();
            struct.columns.add(_elem24);
          }
        }
        struct.setColumnsIsSet(true);
      }
