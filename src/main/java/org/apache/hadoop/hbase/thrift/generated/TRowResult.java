...
public class TRowResult implements org.apache.thrift.TBase<TRowResult, TRowResult._Fields>, java.io.Serializable, Cloneable, Comparable<TRowResult> {
  ...
  public java.util.Map<java.nio.ByteBuffer,TCell> columns; // required
  ...
  public TRowResult(
    ...
    java.util.Map<java.nio.ByteBuffer,TCell> columns)
  {
    this();
  ...
  public TRowResult setRow(java.nio.ByteBuffer row) {
    this.row = org.apache.thrift.TBaseHelper.copyBinary(row);
    return this;
  }
  ...
  public TRowResult setColumns(java.util.Map<java.nio.ByteBuffer,TCell> columns) {
    this.columns = columns;
    return this;
  }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRowResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, TCell> _iter12 : struct.columns.entrySet())
          {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, TCell> _iter13 : struct.columns.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.HashMap<java.nio.ByteBuffer,TCell>(2*_map14.size);
          java.nio.ByteBuffer _key15;
          TCell _val16;
          for (int _i17 = 0; _i17 < _map14.size; ++_i17)
          {
            ...
            _val16 = new TCell();
            _val16.read(iprot);
            struct.columns.put(_key15, _val16);
          }
        }
        struct.setColumnsIsSet(true);
      }
